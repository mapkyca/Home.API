...
namespace home_api\templates {
    ...
    abstract class Template {
         ...
         */
        abstract public function view($view, array $vars = null, $viewtype = 'default');
         ...
         * @return bool
         */
        abstract public function viewExists($view, $viewtype = 'default');
         ...
         */
        abstract public function outputPage($title, $body, array $vars = null, $viewtype = 'default', $return_value = false);
         ...
         * @return type 
         */
        public function screen($screen, array $vars = null, $viewtype = 'default') {
         ...
         */
        public static function v($view, array $vars = null, $viewtype = 'default') {
        ...
        public static function &getInstance() {
            if (!self::$template)
                self::setInstance(\home_api\core\SubsystemFactory::factory('template'));
