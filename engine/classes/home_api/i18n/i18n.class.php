    ...
    abstract class i18n {
        ...
        public static function transliterate($string) {
            ...
            if (!is_callable('iconv'))
                throw new \home_api\core\exceptions\i18nException(i18n::w('i18n:exception:function_iconv_missing'));
        ...
        public static function &getInstance() {
            if (!self::$i18n) {
                self::setInstance(\home_api\core\SubsystemFactory::factory('i18n'));
            }
