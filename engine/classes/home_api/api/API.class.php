...
namespace home_api\api {
    
    use home_api\core\Log as Log;
    use home_api\core\Page as Page;
    use home_api\i18n\i18n as i18n;
    use home_api\core\Input as Input;
    use home_api\templates\Template as Template;
    use home_api\plugins\Plugin as Plugin;
    ...
    abstract class API {
        ...
        public static function register($endpoint, $definition) {
            ...
            if (!isset($definition['class'])) 
                throw new APIException(\home_api\i18n\i18n::w ('api:exception:class_not_specified', array($endpoint)));

            if (!class_exists($definition['class'])) 
                throw new APIException(\home_api\i18n\i18n::w ('api:exception:class_not_found', array($definition['class'])));
        ...
        public static function init($path_to_api_definitions) {
            ...
            Page::create('api', '\home_api\api\API::pageHandler');
