...
class Errors {
    ...
    public static function __error_handler($errno, $errmsg, $filename, $linenum, $vars) {
        ...
        if (!class_exists('Stats')) require_once(dirname(__FILE__) . '/Stats.class.php');
        if (!class_exists('EtsyStatsdStats')) require_once(dirname(__FILE__) . '/EtsyStatsdStats.class.php');
